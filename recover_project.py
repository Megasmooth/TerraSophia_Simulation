...
'''
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                raw_res = f"PENSAMENTO: Erro interno HTTP. ACAO: {{\"action\": \"move\", \"args\": {{\"direction\": \"stay\"}}}}"
        except Exception as e:
            raw_res = f"PENSAMENTO: Custo cognitivo excedido (Timeout). ACAO: {{\"action\": \"move\", \"args\": {{\"direction\": \"stay\"}}}}"
...
with open(path, 'w', encoding='utf-8') as f:
    f.write(code.strip())
print("✓ PROJETO RECUPERADO. Fenótipos originais, Alinhamento, Energia e Cérebro Lógico reinstalados.")
